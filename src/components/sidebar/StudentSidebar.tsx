      ...
      return(
        ...
        <nav className="mt-5 px-2">
          ...
          <div className="space-y-4">
            ...
            {/* Students */}
            <div className="space-y-1">
              <button className="w-full flex items-center justify-between px-4 py-2.5 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white focus:outline-none">
                <div className="flex items-center cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="text-white h-6 w-6 mr-3"
            ...
            <div className="mb-2 relative">
              <label
                ...
                className="flex items-center px-12 py-2 mt-2 text-gray-100 hover:bg-gray-700 rounded-lg cursor-pointer w-full"
              >
                Messages
              </label>
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                className="absolute top-2 left-4 text-white h-6 w-6 mr-2"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
