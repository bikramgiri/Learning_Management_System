...
function Lessons() {
  ...
  const filtredLessons = lessons.filter(
    (lesson) =>
      ...
      formatDate(lesson.createdAt.toString())
        .toLowerCase()
  ...
  const currentItems =
    filtredLessons?.slice(indexOfFirstItem, indexOfLastItem) || [];
      ...
      <div className=" overflow-x-auto">
        ...
        {/* <div>
            <button
              ...
              className="cursor-pointer p-2 rounded-md group transition-all dark:text-white duration-500  flex bg-indigo-600 item-center"
            >
              Back to Courses
            </button>
        </div> */}
        {currentItems.length > 0 ? (
          ...
          <div className="flex relative text-gray-500 focus-within:text-gray-900 mt-0 mb-4 justify-between">
            ...
            />
            <div className="justify-end absolute inset-y-0 ml-65 flex items-center pl-3 pointer-events-none ">
              <svg
                      ...
                      >
                        ...
                        <td className=" p-5 ">
                          <div className="flex items-center gap-1">
                            ...
                            <button
                              onClick={() => deleteLeson(lesson._id)}
          ...
          {/* <div className="flex justify-center py-40">
            <p className="mt-4 text-xl text-gray-500">No lessons available!</p>
          </div> */}
          <div className="flex justify-center py-40">
                {status === 'loading' ? (
                  <p className="p-5 text-center text-xl font-medium text-gray-600 "> Loading lessons... </p>
                ) : (
                  <p className="p-5 text-center text-xl font-medium text-gray-600 "> No lessons available! </p>
                )}
          </div>
          </>
        )}
