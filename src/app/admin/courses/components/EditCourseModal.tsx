...
import { updateCourse, reSetStatus } from "@/store/admin/course/courseSlice";
...
const Modal: React.FC<IModalProps> = ({ closeModal, categoryId, course }) => {
  ...
  const [formData, setFormData] = useState<ICourseForData>({
    title: "",
    featureImage: "",
    description: "",
    price: 0,
  ...
  useEffect(() => {
    if (course) {
      ...
      setFormData({ title: "", description: "", featureImage: "", price: 0, duration: "", category: categoryId });
    }
  }, [course, categoryId]);
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
      ...
      if (course) {
        ...
        console.log("Create category not implemented");
      }
    };
            ...
            <div className="mt-2">
              ...
              >
                {categories.length > 0 ? (
                  ...
                  <option id="no-category" value="" className="">
